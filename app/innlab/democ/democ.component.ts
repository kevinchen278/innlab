...
@Component({
	templateUrl: `./app/innlab/democ/democ.component.html`,
	styleUrls: ['./app/innlab/democ/democ.component.css']
})


export class DemocComponent implements OnActivate {
		...
		if (c_width>639) {
			...
			//layer 1
			el.children[0].style.left = pad_left + 1*row_width;
			el.children[0].style.top = level_top1 ;
			
			//layer 2
			el.children[1].style.left = pad_left + 0.5*row_width;
			el.children[1].style.top = level_top1 + level_height ;

			el.children[2].style.left = pad_left + 1.5*row_width;
			...
			el.children[8].style.top = level_top1 + 2*level_height + 13 ;

			el.children[4].style.left = pad_left + 2*row_width ;
